        ...
        <nav class="navbar navbar-dropdown navbar-fixed-top collapsed">
            <div class="container-fluid">
                <div class="navbar-brand">
                    ...
                    <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-7" href="#">FloodLight</a></span>
                </div>
        ...
        <div class="row mt-5 mb-5 justify-content-center">
            <div class="col-md-8 col-lg-8 col-sm-8">
                <div class="row align-items-center justify-content-center mb-5">
                    <div class="col-md-4">
                        <img src="../img_aux/user (1).png" alt="">
                    </div>

                    <div class="col-md-6">
                        <span class="nome_user"><?php echo $user_data['usuario_adm'] ?></span>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 mt-4">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                $sql4 = "SELECT * FROM usuarios where id_usuario = $solicitante";
                                ...
                                <tr>
                                    ...
                                    <td scope="row"><?php echo $data4['nome_organizador'] ?></td>
                                    <td scope="row"><?php echo $data3['descricao_evento_user'] ?></td>
                                    <td scope="row"><?php echo $data3['vagas_evento_user'] ?></td>
                                    <td><img src="<?php echo '../img_evento/' . $data3['img_evento_user']; ?>" class="img-fluid"></td>
                                    <td class="text-center"><?php echo "
                                            <a href='aprova.php?id_soli=$data[id_solicitacao]' class='btn btn-primary bi bi-check'></a>
                                            <a href='recusa.php?id_soli=$data[id_solicitacao]' class='btn btn-danger bi bi-x'></a>"
                                            ?>
                                    </td>
                                </tr>
                                <?php
