...
<body>
    ...
    <section data-bs-version="5.1" class="gallery4 mbr-gallery cid-tjpWY9yyX1" id="gallery4-3">
        ...
        <div class="container">
            <div class="row justify-content-center row-cols-1 row-cols-md-2 g-4 cards  mb-5">

                <?php

                $sql_noticias = "SELECT * FROM evento_publicado where id_evento_pub = $id_evento";
                $resultado_noticias = mysqli_query($conn, $sql_noticias);

                $cont = 0;

                $evento = mysqli_fetch_assoc($resultado_noticias)

                ?>

                <div class="col-md-6 col-sm-4 tam2">
                    <img src="../img_evento/<?php echo $evento['img_evento_pub']; ?>" class="img-fluid" alt="...">
                </div>

                <div class="col-md-4 col-sm-4 tam2">
                    <h5 class="card-title"><?php echo $evento['titulo_evento_pub']; ?></h5>
                    <br>
                    <p class="card-text"><?php echo $evento['descricao_evento_pub']; ?></p>
                    <a href="save_inscricao.php" class="btn btn-primary">Inscreva-se</a>
                </div>
